...
bool is_fileempty(ifstream file) { return file.peek() == ifstream::traits_type::eof(); }
...
int main(int argc, char *argv[]) {
  string order =
      "inverse,fixed[$1$],byte[$1$],bit[$1$],fixed[$2$],byte[$2$],bit[$2$],fixed[$4$],byte[$4$],"
      "bit[$4$],fixed[$8$],byte[$8#],bit[$8$],fixed[$12$],byte[$12$],bit[$12$],linear,bubble";
