...
int main(int argc, char *argv[])
{
    ...
    cout << setw(30) << "fixed[1]: " << flush << vigna_ktsl<ranking::Word<fenwick::FixedF>>(sigmainv.get(), rho.get(), len);
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n";

    begin = high_resolution_clock::now();
    cout << setw(30) << "fixed[2]: " << flush << vigna_ktsl<ranking::Stride<fenwick::FixedF, 2>>(sigmainv.get(), rho.get(), len);
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n";

    begin = high_resolution_clock::now();
    cout << setw(30) << "fixed[4]: " << flush << vigna_ktsl<ranking::Stride<fenwick::FixedF, 4>>(sigmainv.get(), rho.get(), len);
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n";

    begin = high_resolution_clock::now();
    cout << setw(30) << "fixed[8]: " << flush << vigna_ktsl<ranking::Stride<fenwick::FixedF, 8>>(sigmainv.get(), rho.get(), len);
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n";

    begin = high_resolution_clock::now();
    cout << setw(30) << "fixed[12]: " << flush << vigna_ktsl<ranking::Stride<fenwick::FixedF, 12>>(sigmainv.get(), rho.get(), len);
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n";
    ...
    begin = high_resolution_clock::now();
    cout << setw(30) << "bubble: " << setw(15) << 0 << " bits\t" << flush << diligent_bubblesort(sigma.get(), rho.get(), len) ;
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n" << endl;

/*
    begin = high_resolution_clock::now();
    cout << setw(30) << "vigna ktsl (word naive): " << flush << vigna_ktsl<Word<FixedF>>(sigmainv.get(), rho.get(), len);
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n";

    begin = high_resolution_clock::now();
    cout << setw(30) << "vigna ktsl (word byte): " << flush << vigna_ktsl<Word<ByteF>>(sigmainv.get(), rho.get(), len);
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n";

    begin = high_resolution_clock::now();
    cout << setw(30) << "vigna ktsl (line naive 8): " << flush << vigna_ktsl<Stride<FixedF, 8>>(sigmainv.get(), rho.get(), len);
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n";

    begin = high_resolution_clock::now();
    cout << setw(30) << "vigna ktsl (line byte 8): " << flush << vigna_ktsl<Stride<ByteF, 8>>(sigmainv.get(), rho.get(), len);
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n";

    begin = high_resolution_clock::now();
    cout << setw(30) << "vigna ktsl (line naive 16): " << flush << vigna_ktsl<Stride<FixedF, 16>>(sigmainv.get(), rho.get(), len);
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n";

    begin = high_resolution_clock::now();
    cout << setw(30) << "vigna ktsl (line byte 16): " << flush << vigna_ktsl<Stride<ByteF, 16>>(sigmainv.get(), rho.get(), len);
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n";

    begin = high_resolution_clock::now();
    cout << setw(30) << "vigna ktsl (line naive 32): " << flush << vigna_ktsl<Stride<FixedF, 32>>(sigmainv.get(), rho.get(), len);
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n";

    begin = high_resolution_clock::now();
    cout << setw(30) << "vigna ktsl (line byte 32): " << flush << vigna_ktsl<Stride<ByteF, 32>>(sigmainv.get(), rho.get(), len);
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n";
    ...
    begin = high_resolution_clock::now();
    cout << setw(30) << "vigna ktsl (prezza preinit): " << flush << vigna_ktsl_prezza(prezzabv, sigmainv.get(), rho.get(), len);
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n";

    begin = high_resolution_clock::now();
    cout << setw(30) << "vigna ktsl (prezza): " << flush << vigna_ktsl_prezza(sigmainv.get(), rho.get(), len);
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n";

    begin = high_resolution_clock::now();
    cout << setw(30) << "vigna linearsearch: " << flush << vigna_linearsearch(sigmainv.get(), rho.get(), len);
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n";

    begin = high_resolution_clock::now();
    cout << setw(30) << "diligent bubblesort: " << setw(15) << 0 << " bits\t" << flush << diligent_bubblesort(sigma.get(), rho.get(), len) ;
    end = high_resolution_clock::now();
    cout << setw(15) << duration_cast<chrono::nanoseconds>(end-begin).count() << " nsec\n" << endl;
*/
