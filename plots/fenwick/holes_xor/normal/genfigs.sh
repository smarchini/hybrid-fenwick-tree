...
def large_x(fig):
    if fig == 'prefix.csv': return (5*10**3, 3*10**9)
    if fig == 'add.csv': return (5*10**3, 3*10**9)
    if fig == 'find.csv': return (5*10**3, 3*10**9)
    return None

def large_y(fig):
    if fig == 'prefix.csv': return (0, 300)
    if fig == 'add.csv': return (0, 400)
    if fig == 'find.csv': return (0, 800)
    return None
