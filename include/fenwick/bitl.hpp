...
public:
  ...
  ~BitL() {
    using namespace std;
    ofstream fprefix(std::string("address_BitL_prefix_") + STRINGIFY(MAGIC) + ".txt", std::ofstream::app);
    ofstream fadd(std::string("address_BitL_add_") + STRINGIFY(MAGIC) + ".txt", std::ofstream::app);
    ofstream ffind(std::string("address_BitL_find_") + STRINGIFY(MAGIC) + ".txt", std::ofstream::app);
