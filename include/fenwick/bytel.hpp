...
public:
  ...
  ~ByteL() {
    using namespace std;
    ofstream fprefix(std::string("address_ByteL_prefix_") + STRINGIFY(MAGIC) + ".txt", std::ofstream::app);
    ofstream fadd(std::string("address_ByteL_add_") + STRINGIFY(MAGIC) + ".txt", std::ofstream::app);
    ofstream ffind(std::string("address_ByteL_find_") + STRINGIFY(MAGIC) + ".txt", std::ofstream::app);
