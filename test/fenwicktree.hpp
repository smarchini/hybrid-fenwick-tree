...
template <std::size_t S> void fenwick_random_test(std::size_t size) {
  ...
  for (size_t i = 0; i <= size; i++) {
    ...
    EXPECT_EQ(naive_prefix, lnaive.prefix(i))
        << "At index: " << i << "\nsize: " << size << "\ntemplate parameter: " << S;
    EXPECT_EQ(naive_prefix, bit.prefix(i))
        << "At index: " << i << "\nsize: " << size << "\ntemplate parameter: " << S;
    EXPECT_EQ(naive_prefix, lbit.prefix(i))
        << "At index: " << i << "\nsize: " << size << "\ntemplate parameter: " << S;
    EXPECT_EQ(naive_prefix, byte.prefix(i))
        << "At index: " << i << "\nsize: " << size << "\ntemplate parameter: " << S;
  ...
  for (std::uint64_t i = 0; i <= size; i++) {
    ...
    EXPECT_EQ(naive_find, lnaive.find(i))
        << "At index: " << i << "\nsize: " << size << "\ntemplate parameter: " << S;
    EXPECT_EQ(naive_find, bit.find(i))
        << "At index: " << i << "\nsize: " << size << "\ntemplate parameter: " << S;
    EXPECT_EQ(naive_find, lbit.find(i))
        << "At index: " << i << "\nsize: " << size << "\ntemplate parameter: " << S;
    EXPECT_EQ(naive_find, byte.find(i))
        << "At index: " << i << "\nsize: " << size << "\ntemplate parameter: " << S;
  ...
  for (std::uint64_t i = 0; i <= size; i++) {
    ...
    EXPECT_EQ(naive_findcomplement, lnaive.compFind(i))
        << "At index: " << i << "\nsize: " << size << "\ntemplate parameter: " << S;
    EXPECT_EQ(naive_findcomplement, bit.compFind(i))
        << "At index: " << i << "\nsize: " << size << "\ntemplate parameter: " << S;
    EXPECT_EQ(naive_findcomplement, lbit.compFind(i))
        << "At index: " << i << "\nsize: " << size << "\ntemplate parameter: " << S;
    EXPECT_EQ(naive_findcomplement, byte.compFind(i))
        << "At index: " << i << "\nsize: " << size << "\ntemplate parameter: " << S;
