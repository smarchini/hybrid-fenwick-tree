#ifndef __TEST_FENWICK_LBIT_HPP__
#define __TEST_FENWICK_LBIT_HPP__
...
TEST(lbit_fenwick_tree, increments_by_one) {
  // heigth   3 |                   2 |                                   1 | 0 node     8 | 12 4 |
  // 14      10       6       2 |      15      13      11       9       7       5       3       1
  // 0000001000 | 000000100 000000100 | 00000010 00000010 00000010 00000010 | 0000001 0000001
  // 0000001 0000001 0000001 0000001 0000001 0000001
  BitL_Test t(inc1, 15);

  std::string tree_str = "0000001000000000100000000100000000100000001000000010000000100000001000000"
                         "1000000100000010000001000000100000010000001";
...
TEST(lbit_fenwick_tree, increasing_increments) {
  // heigth   3 |                   2 |                                   1 | 0 node     8 | 12 4 |
  // 14      10       6       2 |      15      13      11       9       7       5       3       1
  // 0000100100 | 000101010 000001010 | 00011011 00010011 00001011 00000011 | 0001111 0001101
  // 0001011 0001001 0000111 0000101 0000011 0000001
  BitL_Test t(inc2, 15);

  std::string tree_str = "0000100100000101010000001010000110110001001100001011000000110001111000110"
                         "1000101100010010000111000010100000110000001";
  EXPECT_EQ(tree_str, tree_tostring(t.Tree.get(), tree_str.length()));
...
TEST(lbit_fenwick_tree, non_complete) {
  // heigth    4 |          3 |                             2 | 1 | 0 node     16 |          8 | 20
  // 12        4 |           18      14      10       6       2 |      19      17      15      13 11
  // 9       7       5       3       1 00000010000 | 0000001000 | 000000100 000000100 000000100 |
  // 00000010 00000010 00000010 00000010 00000010 | 0000001 0000001 0000001 0000001 0000001 0000001
  // 0000001 0000001 0000001 0000001
  BitL_Test t(inc3, 20);

  std::string tree_str =
      "00000010000000000100000000010000000010000000010000000010000000100000001000000010000000100000"
      "001000000100000010000001000000100000010000001000000100000010000001";
  EXPECT_EQ(tree_str, tree_tostring(t.Tree.get(), tree_str.length()));
...
#endif // __TEST_FENWICK_LBIT_HPP__
