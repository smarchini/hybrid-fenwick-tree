...
TEST(lbyte_fenwick_tree, increments_by_one) {
  // heigth         3 |                                 2 |                                   1 | 0
  // node           8 |               12                4 |       14       10        6        2 | 15
  // 13       11        9        7        5        3        1 0000000000001000 | 0000000000000100
  // 0000000000000100 | 00000010 00000010 00000010 00000010 | 00000001 00000001 00000001 00000001
  // 00000001 00000001 00000001 00000001
  ByteL_Test t(inc1, 15);

  std::string tree_str = "0000000000001000000000000000010000000000000001000000001000000010000000100"
                         "00000100000000100000001000000010000000100000001000000010000000100000001";
...
TEST(lbyte_fenwick_tree, increasing_increments) {
  // heigth         3 |                                 2 |                                   1 | 0
  // node           8 |               12                4 |       14       10        6        2 | 15
  // 13       11        9        7        5        3        1 0000000000100100 | 0000000000101010
  // 0000000000001010 | 00011011 00010011 00001011 00000011 | 00001111 00001101 00001011 00001001
  // 00000111 00000101 00000011 00000001
  ByteL_Test t(inc2, 15);

  std::string tree_str = "0000000000100100000000000010101000000000000010100001101100010011000010110"
                         "00000110000111100001101000010110000100100000111000001010000001100000001";
  EXPECT_EQ(tree_str, tree_tostring(t.Tree.get(), tree_str.length()));
...
TEST(lbyte_fenwick_tree, non_complete) {
  // heigth         4 |                3 |                                                  2 | 1 |
  // 0 node          16 |                8 |               20               12                4 | 18
  // 14       10        6        2 |       19       17       15       13       11        9       7
  // 5        3        1 0000000000010000 | 0000000000001000 | 0000000000000100 0000000000000100
  // 0000000000000100 | 00000010 00000010 00000010 00000010 00000010 | 00000001 00000001 00000001
  // 00000001 00000001 00000001 00000001 00000001 00000001 00000001

  ByteL_Test t(inc3, 20);

  std::string tree_str = "0000000000010000000000000000100000000000000001000000000000000100000000000"
                         "0000100000000100000001000000010000000100000001000000001000000010000000100"
                         "000001000000010000000100000001000000010000000100000001";
  EXPECT_EQ(tree_str, tree_tostring(t.Tree.get(), tree_str.length()));
